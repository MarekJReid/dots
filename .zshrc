...
#Fix Jetbrains Aliases
alias jbmw="rm ~/.var/app/com.jetbrains.WebStorm/config/JetBrains/WebStorm2023.2/.lock"
alias jbglmw="rm /home/aurora/.var/app/com.jetbrains.GoLand/config/JetBrains/GoLand2023.2/.lock"
#Git Aliases
alias gc='git add . && git commit -m "' 

alias cdr='cd ~/Documents/Repos'
alias cdrk='cd ~/Documents/Repos/kifabs'
...
alias csu="conky -d -c ~/.conky/startup-collection/cool.conkyrc"
...
znsc() {
    zellij -s "$1" -l "$2" options --theme nord
}
